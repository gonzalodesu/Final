...
namespace InventoryManagement
{
    ...
    {
        SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\gonza\Downloads\design-main\design-main\IMS-main\IMS-main\InventoryManagement\InventoryManagement\Inv.mdf;Integrated Security=True");
        public Login()
        {
            InitializeComponent();
        }
